...
abstract class ProfileSettingsActivity<T : AbstractBean>(
    ...
    val proxyEntity by lazy { SeeWDatabase.proxyDao.getById(DataStore.editingId) }
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menu.findItem(R.id.action_move)?.apply {
            if (DataStore.editingId != 0L // not new profile
                && SeeWDatabase.groupDao.getById(DataStore.editingGroup)?.type == GroupType.BASIC // not in subscription group
