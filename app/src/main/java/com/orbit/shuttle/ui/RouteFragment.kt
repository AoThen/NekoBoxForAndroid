...
import com.orbit.shuttle.database.RuleEntity
import com.orbit.shuttle.database.SeeWDatabase
import com.orbit.shuttle.databinding.LayoutEmptyRouteBinding
import com.orbit.shuttle.databinding.LayoutRouteItemBinding
    ...
    inner class RuleAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>(), ProfileManager.RuleListener, UndoSnackbarManager.Interface<RuleEntity> {
        ...
        fun commitMove() = runOnDefaultDispatcher {
            if (updated.isNotEmpty()) {
                SeeWDatabase.rulesDao.updateRules(updated.toList())
                updated.clear()
                needReload()
            }
        }
