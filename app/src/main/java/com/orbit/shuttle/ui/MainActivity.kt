...
import com.orbit.shuttle.bg.SeeWConnection
...
import com.orbit.shuttle.databinding.LayoutMainBinding
import com.orbit.shuttle.fmt.AbstractBean
import com.orbit.shuttle.fmt.KryoConverters
import com.orbit.shuttle.fmt.PluginEntry
import com.orbit.shuttle.group.GroupInterfaceAdapter
import com.orbit.shuttle.group.GroupUpdater
import com.orbit.shuttle.ktx.alert
import com.orbit.shuttle.ktx.isPlay
import com.orbit.shuttle.ktx.isPreview
import com.orbit.shuttle.ktx.launchCustomTab
import com.orbit.shuttle.ktx.onMainDispatcher
import com.orbit.shuttle.ktx.parseProxies
...
class MainActivity : ThemedActivity(),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.fab.setOnClickListener {
            if (DataStore.serviceState.canStop) SeeWApp.stopService() else connect.launch(
                null
            )
        }
    ...
    val connection = SeeWConnection(SeeWConnection.CONNECTION_ID_MAIN_ACTIVITY_FOREGROUND, true)
    override fun onServiceConnected(service: ISeeWService) = changeState(
        try {
    ...
    override fun onStart() {
        connection.updateConnectionId(SeeWConnection.CONNECTION_ID_MAIN_ACTIVITY_FOREGROUND)
        super.onStart()
    }

    override fun onStop() {
        connection.updateConnectionId(SeeWConnection.CONNECTION_ID_MAIN_ACTIVITY_BACKGROUND)
        super.onStop()
    }
