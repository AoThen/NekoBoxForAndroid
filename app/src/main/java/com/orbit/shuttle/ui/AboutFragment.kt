...
import com.orbit.shuttle.databinding.LayoutAboutBinding
                    ...
                    MaterialAboutCard.Builder()
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .subText(SeeWApp.appVersionNameForDisplay)
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/AoThen/NekoBoxForAndroid/releases"
                                    )
                                }
                                .build())
                        .addItem(
                        ...
                        .addItem(
                            MaterialAboutActionItem.Builder()
                                ...
                                .setOnClickAction {
                                    requireContext().launchCustomTab(
                                        "https://github.com/AoThen/NekoBoxForAndroid"
                                    )
                                }
                                .build())
                        .apply {
            ...
            runOnIoDispatcher {
                try {
                    ...
                    val response = client.newRequest().apply {
                        if (checkPreview) {
                            setURL("https://api.github.com/repos/AoThen/NekoBoxForAndroid/releases/tags/preview")
                        } else {
                            setURL("https://api.github.com/repos/AoThen/NekoBoxForAndroid/releases/latest")
                        }
                    }.execute()
                            ...
                            MaterialAlertDialogBuilder(context)
                                ...
                                .setMessage(
                                    context.getString(
                                        ...
                                        SeeWApp.appVersionNameForDisplay,
                                        releaseName
                                    )
                                )
