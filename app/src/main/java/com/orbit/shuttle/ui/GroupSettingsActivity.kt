...
import com.orbit.shuttle.widget.OutboundPreference
...
class GroupSettingsActivity(
        ...
        if (savedInstanceState == null) {
            ...
            runOnDefaultDispatcher {
                if (editingId == 0L) {
                    ...
                    val entity = SeeWDatabase.groupDao.getById(editingId)
                    if (entity == null) {
                        onMainDispatcher {
                            finish()
                        }
    ...
    suspend fun saveAndExit() {
        ...
        if (editingId == 0L) {
            ...
            val entity = SeeWDatabase.groupDao.getById(DataStore.editingId)
            if (entity == null) {
                finish()
                return
            }
