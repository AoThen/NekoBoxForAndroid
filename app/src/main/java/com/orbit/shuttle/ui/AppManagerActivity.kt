...
import com.orbit.shuttle.databinding.LayoutAppsBinding
import com.orbit.shuttle.databinding.LayoutAppsItemBinding
import com.orbit.shuttle.ktx.Logs
import com.orbit.shuttle.ktx.app
import com.orbit.shuttle.ktx.crossFadeFrom
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.action_export_clipboard -> {
                val success =
                    SeeWApp.trySetPrimaryClip("${DataStore.bypass}\n${DataStore.individual}")
                Snackbar.make(
                    binding.list,
            ...
            R.id.action_import_clipboard -> {
                val proxiedAppString =
                    SeeWApp.clipboard.primaryClip?.getItemAt(0)?.text?.toString()
