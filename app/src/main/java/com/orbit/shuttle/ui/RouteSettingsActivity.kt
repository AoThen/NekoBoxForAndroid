...
import com.orbit.shuttle.widget.AppListPreference
...
class RouteSettingsActivity(
        ...
        if (savedInstanceState == null) {
            ...
            runOnDefaultDispatcher {
                if (editingId == 0L) {
                    ...
                    val ruleEntity = SeeWDatabase.rulesDao.getById(editingId)
                    if (ruleEntity == null) {
                        onMainDispatcher {
                            finish()
                        }
    ...
    suspend fun saveAndExit() {
        ...
        if (editingId == 0L) {
            ...
            val entity = SeeWDatabase.rulesDao.getById(DataStore.editingId)
            if (entity == null) {
                finish()
                return
            }
