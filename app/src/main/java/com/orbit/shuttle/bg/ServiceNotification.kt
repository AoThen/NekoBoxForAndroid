...
import com.orbit.shuttle.ui.SwitchActivity
import com.orbit.shuttle.utils.Theme
...
class ServiceNotification(
    ...
    companion object {
        ...
        fun genTitle(ent: ProxyEntity): String {
            val gn = if (DataStore.showGroupInNotification)
                SeeWDatabase.groupDao.getById(ent.groupId)?.displayName() else null
    ...
    private val builder = NotificationCompat.Builder(service as Context, channel)
        ...
        .setContentIntent(SeeWApp.configureIntent(service))
