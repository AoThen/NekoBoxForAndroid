...
import com.orbit.shuttle.bg.AbstractInstance
...
import com.orbit.shuttle.fmt.ConfigBuildResult
import com.orbit.shuttle.fmt.buildConfig
import com.orbit.shuttle.fmt.hysteria.HysteriaBean
import com.orbit.shuttle.fmt.hysteria.buildHysteria1Config
...
abstract class BoxInstance(
    ...
    override fun launch() {
        ...
        val cacheDir = File(SeeWApp.application.cacheDir, "tmpcfg")
        cacheDir.mkdirs()
