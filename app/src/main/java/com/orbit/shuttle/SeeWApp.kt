...
import com.orbit.shuttle.ktx.isOss
...
import com.orbit.shuttle.module.utils.cleanWebview
import java.io.File
import androidx.work.Configuration as WorkConfiguration

class SeeWApp : Application(),
    ...
    companion object {
        ...
        lateinit var application: SeeWApp
        ...
        fun startService() = ContextCompat.startForegroundService(
            application, Intent(application, SeeWConnection.serviceClass)
        )
