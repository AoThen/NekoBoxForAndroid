...
object Key {
    ...
    const val DB_PROFILE = "seew_data.db"
...
object Action {
    const val SERVICE = "com.orbit.shuttle.SERVICE"
    const val CLOSE = "com.orbit.shuttle.CLOSE"
    const val RELOAD = "com.orbit.shuttle.RELOAD"

    // const val SWITCH_WAKE_LOCK = "com.orbit.shuttle.SWITCH_WAKELOCK"
    const val RESET_UPSTREAM_CONNECTIONS = "com.orbit.shuttle.RESET_UPSTREAM_CONNECTIONS"
}
