...
import com.orbit.shuttle.bg.ServiceNotification
...
class NativeInterface : BoxPlatformInterface, AppInterface {
    ...
    override fun findConnectionOwner(
        ...
        return SeeWApp.connectivity.getConnectionOwnerUid(
    ...
    override fun selector_OnProxySelected(selectorTag: String, tag: String) {
        ...
        DataStore.baseService?.apply {
            runOnDefaultDispatcher {
                ...
                val ent = SeeWDatabase.proxyDao.getById(id) ?: return@runOnDefaultDispatcher
                // traffic & title
                data.proxy?.apply {
